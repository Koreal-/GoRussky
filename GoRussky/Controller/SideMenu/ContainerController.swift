...
//  GoRussky
//
//  Created by Kartinin Studio on 16.08.2020.
    ...
    func didSelect(option: MenuOptions) {
        ...
        animateMenu(shouldExpand: isExpanded) { _ in
            ...
            case .settings:
                ...
                self.present(nav, animated: true, completion: nil)
            case .logout:
                let alert = UIAlertController(title: nil, message: "Вы уверены что хотите выйти из приложения?", preferredStyle: .actionSheet)
